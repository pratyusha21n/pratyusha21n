...
- Data Analyst with 3+ years of experience in data integration, analytics, and master data concepts in banking and cloud environments.
- Comfortable working with SQL, Python, and Power BI to clean, analyze, and visualize data for business decisions.
- Enjoy exploring real-world datasets, doing EDA, and building dashboards that help stakeholders see the story behind the numbers.
- Open to Data Analyst / Analytics / BI roles (Remote, Hybrid, On-site).
...
<p align="left">
  ...
  <a href="https://github.com/pratyusha21n" target="_blank">
